module UsersHelper
  ...
  def profile_picture user
    user.current_profile_picture.image_url if user and user.current_profile_picture
  end
  ...
  def own_item? item
    current_user and item.user_id.eql? current_user.id
  end
  ...
  def awesome_colors char, chars
    ...
    if org? or anrcho? or lending_library? or survey_maker?
